        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className={`testimonial-card bg-white p-8 rounded-3xl card-shadow-premium card-accent-top hover-glow animate-fadeInUp animate-delay-${index * 100 + 100} relative z-10`}>
                <div className="flex gap-1 mb-4">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <Star key={i} className="w-5 h-5 fill-yellow-400 text-yellow-400" />
                  ))}
                </div>
                <p className="testimonial-card-text text-gray-700 mb-6 leading-relaxed italic">"{testimonial.text}"</p>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="testimonial-card-name font-semibold text-[#151249]">{testimonial.name}</div>
                    <div className="testimonial-card-location text-sm text-gray-500">{testimonial.country}</div>
                  </div>
                </div>
              </div>
            ))}
