    ...
    <div className="pt-16">
      <section className="relative bg-gradient-to-br from-gray-50 via-white to-blue-50 py-28 px-6">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <h1 className="text-6xl md:text-7xl mb-8 font-bold text-[#151249]">Carrier Coaching Service</h1>
          <p className="text-xl md:text-2xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
            Professional career guidance and coaching for global opportunities
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-white px-6">
        <div className="container mx-auto max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { icon: Target, title: 'Career Planning', description: 'Identify your strengths and career path' },
              { icon: Briefcase, title: 'Resume Building', description: 'Create compelling CVs that get noticed' },
              { icon: TrendingUp, title: 'Interview Prep', description: 'Master interviews with expert coaching' }
            ].map((service, index) => (
              <div key={index} className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-orange-400 to-orange-500 flex items-center justify-center mb-6">
      ...
      <section className="py-24 bg-gradient-to-br from-[#151249] via-[#1e1a5e] to-[#151249] text-white px-6">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-5xl mb-6 font-bold">Advance Your Career</h2>
          <p className="text-xl mb-10 text-white/90">Get personalized coaching from career experts</p>
